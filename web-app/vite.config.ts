...
export default defineConfig({
  ...
  test: {
    projects: [
      // Наш новий проект для звичайних юніт-тестів
      {
        extends: true, // Успадковує базові налаштування vite (alias, plugins тощо)
        test: {
          name: "unit",
          environment: "node",
      ...
      // Проект від Storybook (залишаємо як було, він був правильний)
      {
        extends: true,
        plugins: [
          storybookTest({
